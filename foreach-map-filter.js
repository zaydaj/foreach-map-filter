...
function addKeyAndValue(arr,key,value){
    ...
    arr.forEach(function(val){
        val[key] = value;
        // newArr.push(val, key, value) <my original attempt
    });
    return arr;
    // return newArr;
}
...
// note to self: shorter way to do the previous 3 : 
// function doubleValuesWithMap(arr) {
...
//     });
//   }
// did not have to create the new array.
...
function find(arr, searchValue) {
    ...
    }) [0]; // I don't understand this part? Why not an else, undefined? How does the 0 make it show up as undefined?
}
